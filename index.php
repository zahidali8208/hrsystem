          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages/forms/emp/personalInformation/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Personal Information</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/personalAllowance" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Personal Allowance</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/personalEligibility" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Personal Eligibility</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/personalDependent" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Personal Dependent</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/personalAttendance" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Personal Attendance</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages//forms/emp/inOutDetail" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>In Out Details</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/overTime" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Over Time</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/shortTime" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Short Time</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/loanDeduct" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Loan Deduct</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/loanDeductionStop" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Loan Deduction Stop</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/emp/loanAdvance" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Loan Advance</p>
                  </a>
                </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages/forms/province/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Province</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/city/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>City</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/area/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Area</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/designation/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Designation</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/department/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Deparments</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/eligibility/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Eligibilities</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/shift/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Shift</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages/forms/increment/" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Increment</p>
                  </a>
                </li>
