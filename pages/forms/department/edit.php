            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM tbldepartment WHERE departmentID={$departmentID}";
              ...
              <form action="update.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="provinceName" class="form-control" value="<?php echo $row['departmentName'] ?>" name="departmentName" id="exampleInputEmail1" placeholder="Province Name">
                    <input type="hidden" class="form-control" name="departmentID" value="<?php echo $row['departmentID'] ?>" id="exampleInputEmail1">
                  </div>
                  ...
                  ?>
                  <select name="departmentStatus"  class="form-control" data-placeholder="Select a State" style="width: 100%;">
                    <!-- <option select disabled>Select Status</option> -->
                    <option  value="<?php echo $row['departmentStatus'] == 1 ? 1: 0 ?>"><?php echo $row['departmentStatus'] == 1 ? "Active":"Inactive" ?></option>

                    <option value="<?php echo $row['departmentStatus'] == 0 ? 1: 0 ?>"><?php echo $row['departmentStatus'] == 0 ? "Active":"Inactive" ?></option>
                  </select>
                </div>
                </div>
                <!-- /.card-body -->
