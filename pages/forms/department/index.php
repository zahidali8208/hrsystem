              ...
              <form action="insert.php" method="post">
                ...
                <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="areaName" name="departmentName" placeholder="Department Name">
                ...
                <div class="card-footer">
                  <button type="submit" id="addDepartment" name="addDepartment" class="btn btn-primary">Add Department</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
                ...
                <table class="table table-head-fixed table-bordered  text-nowrap">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a href="edit.php?departmentID=<?php echo $row['departmentID']; ?>"><i class="fa fa-edit btn btn-success"></i></a></td>
                      <td><a href="delete.php?departmentID=<?php echo $row['departmentID']; ?>"><i class="fa fa-trash "></i></a></td>
                    </tr>
                    <?php
                       }
                  }
