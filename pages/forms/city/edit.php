            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <?php
                  ...
                  $cityID = $_GET["cityID"];
                  $sql = "SELECT * FROM tblcity WHERE cityID={$cityID}";
              ...
              <form action="update.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    ?>
                    <input type="text" class="form-control" value="<?php echo $row['cityName']; ?>" placeholder="City Name" name="cityName">
                    <input type="hidden" name="cityID" class="form-control" value="<?php echo $row['cityID']; ?>" >
                  </div>
                  ...
                  <option >Select Province</option>
                    <?php
                       $sql1 = "SELECT provinceName FROM tblcity JOIN tblprovince ON tblcity.cityID = tblprovince.provinceID";
                       $result1 = mysqli_query($conn,$sql1);
                       while($row1= mysqli_fetch_assoc($result1)){
                          echo $row1["provinceName"];
                      
                    ?>
                    <option value="<?php echo $row1["provinceName"]; ?>"><?php echo $row1["provinceName"]; ?></option>
                    <?php
                      }
                    ?>
                  ...
                  <option  value="<?php echo $row['cityStatus'] == 1 ? 1: 0 ?>"><?php echo $row['cityStatus'] == 1 ? "Active":"Inactive" ?></option>
                    <option value="<?php echo $row['cityStatus'] == 0 ? 1: 0 ?>"><?php echo $row['cityStatus'] == 0 ? "Active":"Inactive" ?></option>
                  </select>
                </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-primary" name="addCity">Update</button>
                </div>
              </form>
              <?php
                 }}
