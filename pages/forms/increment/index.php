...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Increment Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../index.php">Home</a></li>
              <li class="breadcrumb-item active">Increment Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form action="insert.php" method="post">
                <div class="card-body">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Increment Date</label>
                      <input type="text" class="form-control" id="incrementDate" name="incrementDate" placeholder="Increment Date">
                    </div>
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Old Salary</label>
                      <input type="text" class="form-control" id="oldSalary" name="oldSalary" placeholder="Old Salary">
                    </div>
                  
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Increment Amount</label>
                      <input type="text" class="form-control" id="incrementAmount" name="incrementAmount" placeholder="Increment Amount">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <select name="incrementStatus" class="form-control" data-placeholder="Select a State" style="width: 100%;">
                ...
                <div class="card-footer">
                  <button type="submit" id="addincrement" name="addincrement" class="btn btn-primary">Add Increment</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
  ...
  <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Show Shift</h3>
                  ...
                  <?php
                   if(mysqli_num_rows($result)>0){
                    while($row=mysqli_fetch_assoc($result)){
                      $statusCheck="Active";
                      if($row['shiftStatus']==0){
                         $statusCheck = "Inactive";
                        }
                  ?>
                    <tr>
                      <td><?php echo $row['employeeID']?></td>
                      <td><?php echo $row['incrementDate']?></td> 
                      <td><?php echo $row['oldSalary']?></td>  
                      <td><?php echo $row['incrementAmount']?></td> 
                      <td><?php echo $row['basicSalary']?></td>
                      <td><?php echo $row['incrementStatus']?></td>     
                      <td><?php echo $statusCheck?></td>
                      <td><a href="edit.php?shiftID=<?php echo $row['shiftID']; ?>"><i class="fa fa-edit btn btn-success"></i></a></td>
                      <td><a href="delete.php?shiftID=<?php echo $row['shiftID']; ?>"><i class="fa fa-trash "></i></a></td>
                    </tr>
                    <?php
                       }
                  }
