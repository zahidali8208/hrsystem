...
<head>
  ...
  <title>Loan/Advances Adjustment</title>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Loan/Advances Adjustment</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../index.php">Home</a></li>
              <li class="breadcrumb-item active">Loan/Advances Adjustment</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Loan/Advances Adjustment</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
                ...
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" class="form-control" id="transactionNO" name="employeeID" placeholder="Transaction No.">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" class="form-control" id="Employee Name" name="Employee Name" placeholder="Name">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                      <label>Area</label>
                      <select name="area" class="form-control" data-placeholder="Select a State" style="width: 100%;">
                  ...
                  <div class="form-group col-md-2">
                      ...
                      <select name="position" class="form-control" data-placeholder="Select a State" style="width: 100%;">
  ...
  <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Loan/Advance Details</h3>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Employee Loan/Advances</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insert.php" method="post">
                <div class="card-body">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="date" class="form-control" id="loanDate" name="loanDate" placeholder="Loan Date">
                    </div>
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Loan Type</label>
                      <input type="text" class="form-control" id="loanType" name="loanType" placeholder="Loan Type">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Deduction Limit</label>
                      <input type="text" class="form-control" id="deductionLimit" name="deductionLimit" placeholder="Deduction Limit">
                    </div>
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Deduction Start Date</label>
                      <input type="date" class="form-control" id="deductionStartDate" name="deductionStartDate" placeholder="Deduction Start Date">
                    </div>
                  </div>
                  <div class="form-row">
                  <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Deduction Stop Date</label>
                      <input type="date" class="form-control" id="deductionStopDate" name="deductionStopDate" placeholder="0">
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Cash Received</label>
                      <input type="text" class="form-control" id="cashReceived" name="cashReceived" placeholder="0">
                    </div>
                    <div class="form-group col-md-2">
  ...
  <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Loan/Advance History</h3>
