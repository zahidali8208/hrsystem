...
<head>
  ...
  <title>Employee Loan/Advances</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Employee Loan/Advances</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../index.php">Home</a></li>
              <li class="breadcrumb-item active">Employee Loan/Advances</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-2">
                      ...
                      <select name="loanFor" class="form-control" data-placeholder="" style="width: 100%;">
                    ...
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Aprroved By</label>
                      <input type="text" class="form-control" id="approvedBy" name="approvedBy" placeholder="0">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
