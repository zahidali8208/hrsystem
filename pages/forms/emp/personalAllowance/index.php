...
<head>
  ...
  <title>Personal Allownace</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Personal Allowance Form</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../../../../index.php">Home</a></li>
              <li class="breadcrumb-item active">Personal Allowance Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              ...
              <form action="insert.php" method="post">
                <div class="card-body">
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                      ...
                      <input type="text" class="form-control" id="srNO" name="srNO" placeholder="Serial Number">
                    </div>
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Allowance ID</label>
                      <input type="text" class="form-control" id="allowanceID" name="allowanceID" placeholder="Allowance ID">
                    </div>
                    <div class="form-group col-md-2">
                      <label for="exampleInputEmail1">Allowance Rate</label>
                      <input type="text" class="form-control" id="allowanceRate" name="allowanceRate" placeholder="Allowance Rate">
                    </div>
                    <div class="form-group col-md-2">
                ...
                <div class="card-footer">
                  <button type="submit" id="addAllowance" name="addAllowance" class="btn btn-primary">Add Allowance</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
