              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Area Name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Machine Exist</label>
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Machine Exist">
                  </div> 
                </div>
                <!-- /.card-body -->
