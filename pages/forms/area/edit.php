              ...
              <div class="card-header">
                ...
                <?php
                    include('../../config/config.php"');
                     $areaID = $_GET["areaID"];
                    $sql = "SELECT * FROM tblarea WHERE areaID={$areaID}";
              ...
              <form action="update.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="provinceName" class="form-control" value="<?php echo $row['areaName'] ?>" name="areaName" id="exampleInputEmail1" placeholder="Province Name">
                    <input type="hidden" class="form-control" name="areaID" value="<?php echo $row['areaID'] ?>" id="exampleInputEmail1">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Machine Exist</label>
                    <input type="text" class="form-control" id="machineExist" value="<?php echo $row['machineExist'] ?>" name="machineExist" placeholder="Machine Exist">
                  </div> 
                  ...
                  ?>
                  <select name="areaStatus"  class="form-control" data-placeholder="Select a State" style="width: 100%;">
                    <!-- <option select disabled>Select Status</option> -->
                    <option  value="<?php echo $row['areaStatus'] == 1 ? 1: 0 ?>"><?php echo $row['areaStatus'] == 1 ? "Active":"Inactive" ?></option>

                    <option value="<?php echo $row['areaStatus'] == 0 ? 1: 0 ?>"><?php echo $row['areaStatus'] == 0 ? "Active":"Inactive" ?></option>
                  </select>
                </div>
                </div>
                <!-- /.card-body -->
                ...
                <button type="submit" id="addArea" name="areaUpdate" class="btn btn-primary">Update</button>
                </div>
                </form>
                <?php
                   } 
