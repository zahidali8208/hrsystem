...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="card card-primary">
              ...
              <form action="insert.php" method="post">
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" class="form-control" id="areaName" name="areaName" placeholder="Area Name">
                      <input type="hidden" id="areaName" name="areaID" >
                    </div>
                  <div class="form-group col-md-4">
                    <label for="exampleInputPassword1">Machine Exist</label>
                    <input type="text" class="form-control" id="machineExist" name="machineExist" placeholder="Machine Exist">
                  </div> 
                  <div class="form-group col-md-4">
                ...
                <div class="card-footer">
                  <button type="submit" id="addArea" name="addArea" class="btn btn-primary">Add Area</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
  ...
  <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Show Area </h3>
                ...
                <table class="table table-head-fixed table-bordered  text-nowrap">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $row['machineExist']?></td>
                      <td><?php echo $statusCheck?></td>
                      <td><a href="edit.php?areaID=<?php echo $row['areaID']; ?>"><i class="fa fa-edit btn btn-success"></i></a></td>
                      <td><a href="delete.php?areaID=<?php echo $row['areaID']; ?>"><i class="fa fa-trash "></i></a></td>
                    </tr>
                    <?php
                       }
                  }
