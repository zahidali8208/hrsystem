          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Eligibilities</h3>

                <!-- Select Query  -->
                <?php
                    include('../../config/config.php"');
                     $eligibilitiesID = $_GET["eligibilitiesID"];
                    $sql = "SELECT * FROM tbleligibilities WHERE eligibilitiesID={$eligibilitiesID}";
              ...
              <form action="update.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="eligibilitiesDescription" class="form-control" value="<?php echo $row['eligibilitiesDescription'] ?>" name="eligibilitiesDescription" id="exampleInputEmail1" placeholder="Province Name">
                    <input type="hidden" class="form-control" name="eligibilitiesID" value="<?php echo $row['eligibilitiesID'] ?>" id="exampleInputEmail1">
                  </div>
                  ...
                  <select name="eligibilitiesStatus"  class="form-control" data-placeholder="Select a State" style="width: 100%;">
                    ...
                    <option  value="<?php echo $row['eligibilitiesStatus'] == 1 ? 1: 0 ?>"><?php echo $row['eligibilitiesStatus'] == 1 ? "Active":"Inactive" ?></option>

                    <option value="<?php echo $row['eligibilitiesStatus'] == 0 ? 1: 0 ?>"><?php echo $row['eligibilitiesStatus'] == 0 ? "Active":"Inactive" ?></option>
                  </select>
                </div>
                </div>
                <!-- /.card-body -->
                ...
                <button type="submit" id="eligibilitiesUpdate" name="eligibilitiesUpdate" class="btn btn-primary">Update</button>
                </div>
                </form>
                <?php
                   } 
