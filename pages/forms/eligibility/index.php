...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Eligibilities Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Eligibilities</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="insert.php" method="post">
                <div class="card-body">
                  <div class="form-row">
                      <div class="form-group col-md-4">
                        <label for="exampleInputEmail1">Eligibilities Description</label>
                        <input type="text" class="form-control" id="eligibilitiesDescription" name="eligibilitiesDescription" placeholder="Eligibilities Description">
                        <input type="hidden" id="eligibilitiesID" name="eligibilitiesID" >
                      </div>
                      <div class="form-group col-md-4">
                        <label>Select Status</label>
                        <select name="eligibilitiesStatus" class="form-control" data-placeholder="Select a State" style="width: 100%;">
                ...
                <div class="card-footer">
                  <button type="submit" id="addEligibilities" name="addEligibilities" class="btn btn-primary">Add Eligibilities</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
  ...
  <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Show Eligibilities</h3>
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                <table class="table table-head-fixed table-bordered  text-nowrap">
                  <thead>
                    <tr>
                      <th>Eligibilities ID</th>
                      <th>Eligibilities Description</th>
                      <th>Status</th>
                      <th>Edit</th>
                      <th>Delete</th>
                    </tr>
                  ...
                  <?php
                   ...
                   $sql = "SELECT * FROM tbleligibilities";
                  ...
                  <?php
                   if(mysqli_num_rows($result)>0){
                    while($row=mysqli_fetch_assoc($result)){
                      $statusCheck="Active";
                      if($row['eligibilitiesStatus']==0){
                         $statusCheck = "Inactive";
                        }
                  ?>
                    <tr>
                      <td><?php echo $row['eligibilitiesID']?></td>
                      <td><?php echo $row['eligibilitiesDescription']?></td>     
                      <td><?php echo $statusCheck?></td>
                      <td><a href="edit.php?eligibilitiesID=<?php echo $row['eligibilitiesID']; ?>"><i class="fa fa-edit btn btn-success"></i></a></td>
                      <td><a href="delete.php?eligibilitiesID=<?php echo $row['eligibilitiesID']; ?>"><i class="fa fa-trash "></i></a></td>
                    </tr>
                    <?php
                       }
                  }
