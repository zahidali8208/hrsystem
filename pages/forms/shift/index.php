            ...
            <div class="card card-primary">
              ...
              <form action="insert.php" method="post">
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      ...
                      <input type="time" class="form-control" id="shiftStartTime" name="shiftStartTime" placeholder="Shift Start Time">
                      <input type="hidden" id="shiftID" name="shiftID" >
                    </div>
                    <div class="form-group col-md-4">
                      <label for="exampleInputEmail1">Shift Stop Time</label>
                      <input type="time" class="form-control" id="shiftStopTime" name="shiftStopTime" placeholder="Shift Stop Time">
                    </div>
                    <div class="form-group col-md-4">
                ...
                <div class="card-footer">
                  <button type="submit" id="addShift" name="addShift" class="btn btn-primary">Add Shift</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
                ...
                <table class="table table-head-fixed table-bordered  text-nowrap">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo $row['shiftStartTime']?></td> 
                      <td><?php echo $row['shiftStopTime']?></td>     
