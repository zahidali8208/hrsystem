        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Shift Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM tblshift WHERE shiftID={$shiftID}";
                    
                    $result = mysqli_query($conn,$sql)or die("error");
                   if(mysqli_num_rows($result)>0){
                     while($row=mysqli_fetch_assoc($result)){
                    //  echo $row['shiftID'];
                    //  echo $row['shiftStartTime'];
                    //  echo $row['shiftStopTime'];
                    //  echo $row['shiftStatus'];
              ...
              <form action="update.php" method="post">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Shift Start Time</label>
                    <input type="time" class="form-control" id="shiftStartTime" value="<?php echo $row['shiftStartTime']; ?>" name="shiftStartTime" placeholder="Shift Start Time">
                    <input type="hidden" id="shiftID" name="shiftID" value="<?php echo $row['shiftID']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Shift Stop Time</label>
                    <input type="time" class="form-control" id="shiftStopTime" value="<?php echo $row['shiftStopTime']; ?>" name="shiftStopTime" placeholder="Shift Stop Time">
                  </div>
                  ...
                  ?>
                  <select name="shiftStatus"  class="form-control" data-placeholder="Select a State" style="width: 100%;">
                    <!-- <option select disabled>Select Status</option> -->
                    <option  value="<?php echo $row['shiftStatus'] == 1 ? 1: 0 ?>"><?php echo $row['shiftStatus'] == 1 ? "Active":"Inactive" ?></option>

                    <option value="<?php echo $row['shiftStatus'] == 0 ? 1: 0 ?>"><?php echo $row['shiftStatus'] == 0 ? "Active":"Inactive" ?></option>
                  </select>
                </div>
                </div>
                <!-- /.card-body -->
                ...
                <button type="submit" id="shiftUpdate" name="shiftUpdate" class="btn btn-primary">Update</button>
                </div>
                </form>
                <?php
                   } 
