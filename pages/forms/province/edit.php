            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM tblprovince WHERE provinceID={$provinceID}";
              ...
              <form action="update.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="provinceName" class="form-control" value="<?php echo $row['provinceName'] ?>" name="provinceName" id="exampleInputEmail1" placeholder="Province Name">
                    <input type="hidden" class="form-control" name="provinceID" value="<?php echo $row['provinceID'] ?>" id="exampleInputEmail1">
                  </div>
                  ...
                  ?>
                  <select name="provinceStatus"  class="form-control" data-placeholder="Select a State" style="width: 100%;">
                    <!-- <option select disabled>Select Status</option> -->
                    <option  value="<?php echo $row['provinceStatus'] == 1 ? 1: 0 ?>"><?php echo $row['provinceStatus'] == 1 ? "Active":"Inactive" ?></option>

                    <option value="<?php echo $row['provinceStatus'] == 0 ? 1: 0 ?>"><?php echo $row['provinceStatus'] == 0 ? "Active":"Inactive" ?></option>
                  </select>
                </div>
                </div>
                <!-- /.card-body -->
                ...
                <div class="card-footer">
                  <input type="submit" class="btn btn-primary" value="Add Province" id="addProvince">
                </div>
                </form>
                <?php
                   } 
