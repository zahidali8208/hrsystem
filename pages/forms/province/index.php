                ...
                <div class="card-body">
                  <div class="form-row">
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" id="provinceName" class="form-control" name="provinceName" id="exampleInputEmail1" placeholder="Province Name">
                      <!-- <input type="hidden" class="form-control" name="globalVariable" value="1" id="exampleInputEmail1"> -->
                    </div>
                ...
                <table class="table table-head-fixed table-bordered  text-nowrap">
                  ...
                  ?>
                    <tr>
                      ...
                      <!-- <td>11-7-2014</td> -->
                      <td><span class="tag tag-success"><?php echo $statusCheck  ?></span></td>
                      <td><a href="edit.php?provinceID=<?php echo $row['provinceID']; ?>"><i class="fa fa-edit"></i></a></td>
                      <td><a href="delete.php?provinceID=<?php echo $row['provinceID']; ?>"><i class="fa fa-trash"></i></a></td>
                    </tr>
                    <?php
                       }
                  }
