...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
              ...
              <form action="insert.php" method="post">
                ...
                <div class="form-row">
                      <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="designationName" name="designationName" placeholder="Designation Name">
                ...
                <div class="card-footer">
                  <button type="submit" id="addDesignation" name="addDesignation" class="btn btn-primary">Add Designation</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
  ...
  <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Show Designation </h3>
                ...
                <table class="table table-head-fixed table-bordered  text-nowrap">
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a href="edit.php?designationID=<?php echo $row['designationID']; ?>"><i class="fa fa-edit btn btn-success"></i></a></td>
                      <td><a href="delete.php?designationID=<?php echo $row['designationID']; ?>"><i class="fa fa-trash "></i></a></td>
                    </tr>
                    <?php
                       }
                  }
