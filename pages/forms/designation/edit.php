            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM tbldesignation WHERE designationID={$designationID}";
              ...
              <form action="update.php" method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="designationName" class="form-control" value="<?php echo $row['designationName'] ?>" name="departmentName" id="exampleInputEmail1" placeholder="Province Name">
                    <input type="hidden" class="form-control" name="designationID" value="<?php echo $row['designationID'] ?>" id="exampleInputEmail1">
                  </div>
                  ...
                  ?>
                  <select name="designationStatus"  class="form-control" data-placeholder="Select a State" style="width: 100%;">
                    <!-- <option select disabled>Select Status</option> -->
                    <option  value="<?php echo $row['designationStatus'] == 1 ? 1: 0 ?>"><?php echo $row['designationStatus'] == 1 ? "Active":"Inactive" ?></option>

                    <option value="<?php echo $row['designationStatus'] == 0 ? 1: 0 ?>"><?php echo $row['designationStatus'] == 0 ? "Active":"Inactive" ?></option>
                  </select>
                </div>
                </div>
                <!-- /.card-body -->
                ...
                <button type="submit" id="designationUpdate" name="designationUpdate" class="btn btn-primary">Update</button>
                </div>
                </form>
                <?php
                   } 
